...
{
    var _clientInfo, _parent, _widgetHolder, _widgetID, _hudMetrics, _alpha, _width, _height, _x, _y;
    function WidgetBase()
    {
        super();
        _clientInfo = {};
    ...
    function tweenTo(a_newX, a_newY, a_duration)
    {
        ...
        com.greensock.TweenLite.to(this, _loc2, {_x: _loc4, _y: _loc3, overwrite: 0, easing: com.greensock.easing.Linear.easeNone});
    } // End of the function
    function fadeTo(a_alpha, a_duration)
    {
        var _loc2 = Math.max(0, a_duration || 0);
        com.greensock.TweenLite.to(this, _loc2, {_alpha: a_alpha, overwrite: 0, easing: com.greensock.easing.Linear.easeNone});
    } // End of the function
    function getWidth()
    {
        return (_width);
